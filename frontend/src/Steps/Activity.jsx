    ...
    <div className="grid grid-cols-1 gap-6">
      {activityLevels.map(level => (
        <button
          ...
          className={`
            w-full text-left relative overflow-hidden rounded-xl p-6 cursor-pointer
        ...
        >
          ...
          <div className="flex items-start space-x-6">
            <div className={`
              p-4 rounded-xl transform transition-all duration-300
              ${formData.activity_level === level.id 
            ...
            <div className="flex-grow">
              <div className="flex items-center mb-2">
                <h3 className="text-xl font-semibold text-white">{level.label}</h3>
                {level.factor && (
                  <span className="ml-3 px-3 py-1 rounded-full text-xs font-medium bg-blue-500/20 text-blue-300">
