      ...
      <div className="max-w-4xl mx-auto px-4 py-12 relative">
        <div className="text-center mb-12">
          ...
          <div className="max-w-2xl mx-auto">
            <p className="text-xl text-gray-600 mb-4">Watch the magic happen as we craft your personalized nutrition plan! ✨</p>
            ...
            <div className="flex items-center justify-center space-x-6 mt-6">
              <div className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-green-50 border border-green-200">
                ...
                <span className="text-sm text-green-700 font-medium">Scientifically Proven Methods</span>
              </div>
              ...
              <div className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-blue-50 border border-blue-200">
                ...
                <span className="text-sm text-blue-700 font-medium">Reviewed by Certified Nutritionists</span>
              </div>
            </div>
          </div>
        </div>
