...
import { Droplet, Activity, Scale, Info } from 'lucide-react';

// Helper function to calculate daily water intake
...
const WaterIntakeSection = ({ weight, activityLevel }) => {
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex items-center space-x-3 mb-8">
        ...
        <h2 className="text-2xl font-semibold text-white">Daily Hydration</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="bg-gray-800/50">
          <CardContent className="p-6">
            <h3 className="text-xl font-semibold text-white mb-4">Optimal Hydration Schedule</h3>
            
            <div className="space-y-4">
              {waterTips.map((tip, index) => (
                <div 
                  key={index}
                  className="flex items-start space-x-3 p-3 rounded-lg bg-gray-700/50 hover:bg-gray-700/70 transition-colors duration-300"
                >
